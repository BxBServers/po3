...
recipes.addShaped(<quantumstorage:quantum_tank>, [[<thermalfoundation:glass_alloy>, <appliedenergistics2:material:47>, <thermalfoundation:glass_alloy>],[<appliedenergistics2:material:57>, <aeadditions:certustank>, <appliedenergistics2:material:57>], [<extraplanets:tier5_items:12>, <extraplanets:tier5_items:12>, <extraplanets:tier5_items:12>]]);
...
recipes.addShaped(<overloaded:item_core>, [[<aeadditions:storage.component:2>, <storagedrawers:controller>, <aeadditions:storage.component:2>],[<quantumstorage:quantum_storage_unit>, <projectex:matter:11>, <quantumstorage:quantum_storage_unit>], [<aeadditions:storage.component:2>, <yabba:item_barrel_connector>, <aeadditions:storage.component:2>]]);

...
mods.nuclearcraft.alloy_furnace.removeRecipeWithOutput([<enderio:item_alloy_ingot:0>]);
...
mods.nuclearcraft.alloy_furnace.removeRecipeWithOutput([<enderio:item_alloy_ingot:3>]);
mods.nuclearcraft.alloy_furnace.removeRecipeWithOutput([<enderio:item_alloy_ingot:4>]);
...
mods.nuclearcraft.alloy_furnace.removeRecipeWithOutput([<enderio:item_alloy_ingot:9>]);
...
mods.nuclearcraft.alloy_furnace.addRecipe([<mekanism:ingot:1>, <minecraft:redstone>*2, <projectred-core:resource_item:103>, 1.0, 2.0, 10.0]);
mods.nuclearcraft.alloy_furnace.addRecipe([<mekanism:ingot:1>, <projectred-core:resource_item:105>*2, <projectred-core:resource_item:104>, 1.0, 2.0, 10.0]);
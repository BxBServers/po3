...
mods.extendedcrafting.EnderCrafting.addShaped(<extendedcrafting:material:40>, [[<ore:gemPearl>, <ore:pearlEnderEye>, <ore:gemPearl>], [<ore:pearlEnderEye>, <ore:netherStar>, <ore:pearlEnderEye>], [<ore:gemPearl>, <ore:pearlEnderEye>, <ore:gemPearl>]]);

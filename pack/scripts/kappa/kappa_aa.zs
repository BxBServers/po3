...
mods.actuallyadditions.Empowerer.addRecipe(<quantumflux:craftingpiece:2>, <appliedenergistics2:material:22>, <quantumflux:darkstone:0>, <nuclearcraft:ingot_oxide:1>, <thermalsolars:itemlunaringot>, <quantumflux:darkstone>, 1000, 100, [0.1,0.1,0.1]);
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:item_crystal_empowered:2>, <actuallyadditions:item_crystal:2>, <thermalfoundation:material:160>, <nuclearcraft:gem:0>, <projectred-core:resource_item:104>, <tconstruct:soil:0>, 2000, 100, [0.1,0.1,0.1]);
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:item_crystal_empowered:4>, <actuallyadditions:item_crystal:4>, <minecraft:vine>, <nuclearcraft:ingot:9>, <nuclearcraft:gem:2>, <natura:nether_thorn_vines:0>, 2000, 100, [0.1,0.1,0.1]);
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:block_crystal_empowered:2>, <actuallyadditions:block_crystal:2>, <thermalfoundation:material:160>, <nuclearcraft:gem:0>, <projectred-core:resource_item:104>, <tconstruct:soil:0>, 2000, 100, [0.1,0.1,0.1]);
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:block_crystal_empowered:4>, <actuallyadditions:block_crystal:4>, <minecraft:vine>, <nuclearcraft:ingot:9>, <nuclearcraft:gem:2>, <natura:nether_thorn_vines:0>, 2000, 100, [0.1,0.1,0.1]);

...
recipes.addShapeless(<bigreactors:blockyellorium>, [<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>,<ore:ingotYellorium>]);
//shaped
recipes.addShaped(<quantumstorage:multistorage:3> * 2, [[<ore:plateIron>, <ore:plateIron>, <ore:plateIron>],[<ore:plateIron>, null, <ore:plateIron>], [<ore:plateIron>, <ore:plateIron>, <ore:plateIron>]]);

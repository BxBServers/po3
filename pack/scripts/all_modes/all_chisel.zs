...
mods.chisel.Carving.addGroup("graphite");
mods.chisel.Carving.addVariation("graphite", <bigreactors:blockgraphite>);
mods.chisel.Carving.addVariation("graphite", <nuclearcraft:ingot_block:8>);

mods.chisel.Carving.addVariation("cobblestone", <contenttweaker:ogasexy_block>);